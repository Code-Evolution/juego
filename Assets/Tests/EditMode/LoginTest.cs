...
public class LoginTest {
  ...
  /*
  // Test 3: Verificar que al iniciar la escena, se añade el listener al botón
  de login [Test] public void Start_AddsLoginButtonListener()
  {
  ...
  // Test 4: Verificar que el mensaje de resultado se actualiza correctamente en
  caso de error [UnityTest] public IEnumerator
  Login_SetsResultText_OnConnectionError()
  {
      usernameField.text = "testuser";
      passwordField.text = "testpassword";

      newMonoBehaviour.loginUrl = "http://invalid_url"; // Simulamos una URL
  inválida para forzar un error de conexión
